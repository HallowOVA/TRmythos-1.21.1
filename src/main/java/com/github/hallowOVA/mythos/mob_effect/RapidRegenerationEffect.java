...
public class RapidRegenerationEffect extends SkillMobEffect {
    public RapidRegenerationEffect(MobEffectCategory category, int color) {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        ...
        if (missingHealth > 0.0F && !MobEffectHelper.shouldCancelHeal(entity)) {
            if (entity instanceof Player player) {
                float cost = (amplifier == 0 && SkillUtils.isSkillToggled(entity, Skills.BLOODSUCKER.get())) ? 20.0F : 100.0F;
