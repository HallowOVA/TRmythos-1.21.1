...
import com.github.mythos.mythos.ability.mythos.magic.TestMagic;
...
public class Magics {
    ...
    public static final RegistryObject<TestMagic> TEST_MAGIC = registry.register("test_magic", TestMagic::new);
}
