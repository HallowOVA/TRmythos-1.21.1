...
import com.github.mythos.mythos.ability.mythos.skill.unique.normal.DullahanSkill;
...
public class Skills {
    ...
    public static final RegistryObject<SpiralHeartSkill> SPIRALHEART;
    ...
    public static final RegistryObject<Rememberance> REMEMBERACE;
//    public static final RegistryObject<ShadowSkill> SHADOW;
    ...
    static {
        ...
        SPIRALHEART = registery.register("spiral_heart", SpiralHeartSkill::new);
