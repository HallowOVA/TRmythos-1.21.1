...
public class AesirRace extends Race {
    public AesirRace(Difficulty difficulty) {super(difficulty);}
    public AesirRace() {super(Difficulty.INTERMEDIATE);}
    ...
    public List<Race> getPreviousEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) MythosRaces.UUL_BORN));
        return list;
    }
