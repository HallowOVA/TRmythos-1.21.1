...
public class WraithRace extends Race {
    public WraithRace(Difficulty difficulty) {super(difficulty);}
    public WraithRace() {super(Difficulty.HARD);}
    ...
    private double auraMin = 25000;
    private double auraMax = 25000;
    private double startingMagiculeMin = 75000;
    private double startingMagiculeMax = 75000;
    ...
    public List<Race> getNextEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.FORGOTTEN));
        return list;
    }

    public @Nullable Race getDefaultEvolution(Player player) {
        return ((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.FORGOTTEN));
    }
    ...
    public void raceAbility(Player entity) {
        if (!entity.isSpectator() && !entity.isCreative()) {
            ...
            entity.getAbilities().setFlyingSpeed(0.25F);
