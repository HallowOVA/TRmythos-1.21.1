package com.github.hallowOVA.mythos.race.CanineRaceLines.FenrirRaceLine;
...
public class DreadBeastRace extends Race {
    public DreadBeastRace() {
    ...
    public List<Race> getPreviousEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) MythosRaces.CANINE_RACE));
        return list;
    }
    @Override
    ...
    public double getEvolutionPercentage(Player player) {
        ...
        if (storage.getSkill((ManasSkill) ExtraSkills.WATER_DOMINATION.get()).isPresent()) {
    ...
    public List<Component> getRequirementsForRendering(Player player) {
        ...
        list.add(Component.translatable("trmythos.water_domination.acquired"));
        return list;
    }
