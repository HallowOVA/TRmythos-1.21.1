package com.github.hallowOVA.mythos.race.JormungandrRaceLine;
...
public class SonOfLokiRace extends Race {
    ...
    public List<Race> getNextEvolutions(Player player) {
       ...
       list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.MIDGARDIAN_SPIRIT_RACE));
       return list;
    }
     public @Nullable Race getDefaultEvolution(Player player) {
        return ((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.MIDGARDIAN_SPIRIT_RACE));
    }
