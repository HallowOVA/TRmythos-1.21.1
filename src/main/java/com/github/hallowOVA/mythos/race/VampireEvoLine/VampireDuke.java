...
public class VampireDuke extends Race implements Transformation {
    ...
    public double getJumpHeight() {
        return JumpPowerHelper.defaultPlayer(1.6);
    }
    ...
    public @Nullable Race getDefaultEvolution(Player player) {
        return (Race) TensuraRaces.RACE_REGISTRY.get().getValue(MythosRaces.VAMPIRE_ARCHDUKE);
    }
    ...
    public List<Race> getNextEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.VAMPIRE_ARCHDUKE));
        return list;
    }
