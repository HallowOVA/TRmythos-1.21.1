...
public class MidgardianSpiritRace extends Race {
    ...
    public double getJumpHeight() {
        return JumpPowerHelper.defaultPlayer(1.35);
    }
    ...
    public List<Race> getNextEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.JORMUNGANDR_RACE));
        return list;
    }
    public @Nullable Race getDefaultEvolution(Player player) {
        return ((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.JORMUNGANDR_RACE));
    }
