...
public class VampireViscount extends Race implements Transformation {

    public VampireViscount() {
    ...
    @Override
        ...
        public double getJumpHeight() {
            return JumpPowerHelper.defaultPlayer(1.3);
        }
    ...
    public double getSprintSpeed() {
        ...
        public @Nullable Race getDefaultEvolution(Player player) {
            return (Race) TensuraRaces.RACE_REGISTRY.get().getValue(MythosRaces.VAMPIRE_EARL);
        }
        ...
        public List<Race> getNextEvolutions(Player player) {
            ...
            list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.VAMPIRE_EARL));
            return list;
        }
