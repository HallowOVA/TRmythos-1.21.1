package com.github.hallowOVA.mythos.race.GodlingLines.EgyptianPantheon;
...
public class DivineHostRace extends Race {
    public DivineHostRace() {
    ...
    public List<Component> getRequirementsForRendering(Player player) {
       ...
       list.add(Component.translatable("trmythos.evolution_menu.pre_awakening",
               new Object[]{Component.translatable("trmythos.race.require.demon_lord_seed").withStyle(ChatFormatting.RED)}));
       return list;
    }
