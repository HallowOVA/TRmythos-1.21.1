...
public class LesserDivinityRace extends Race {
    public LesserDivinityRace() {super(Difficulty.EASY);}
    ...
    @Override
    public float getPlayerSize() {return 2f;}
    ...
    public List<Race> getNextEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.MIDDLE_DIVINITY));
        return list;
    }

    public @Nullable Race getDefaultEvolution(Player player) {
        return ((Race)((IForgeRegistry)TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.MIDDLE_DIVINITY));
    }
