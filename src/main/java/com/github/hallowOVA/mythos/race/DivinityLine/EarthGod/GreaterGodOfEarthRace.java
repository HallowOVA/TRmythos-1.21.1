package com.github.hallowOVA.mythos.race.DivinityLine.EarthGod;
...
public class GreaterGodOfEarthRace extends Race {
    public GreaterGodOfEarthRace() {super(Difficulty.EASY);}
