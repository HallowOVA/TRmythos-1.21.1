package com.github.hallowOVA.mythos.race.DivinityLine;
...
public class LesserTitanRace extends Race {
    public LesserTitanRace() {super(Difficulty.EASY);}

    @Override
    public double getBaseHealth() {return 9600;}
    ...
    @Override
    public float getPlayerSize() {return 3f;}
    ...
    public List<Race> getNextEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.TITAN));
        return list;
    }

    public @Nullable Race getDefaultEvolution(Player player) {
        return ((Race)((IForgeRegistry)TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.TITAN));
    }
