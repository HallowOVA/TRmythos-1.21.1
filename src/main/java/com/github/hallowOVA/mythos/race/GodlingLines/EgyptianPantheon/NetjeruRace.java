...
public class NetjeruRace extends Race {
    public NetjeruRace(Difficulty difficulty) {super(difficulty);}
    public NetjeruRace() {super(Difficulty.INTERMEDIATE);}
    ...
    public List<Race> getPreviousEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) MythosRaces.DIVINE_HOST));
        return list;
    }
