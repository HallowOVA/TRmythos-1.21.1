package com.github.hallowOVA.mythos.race.VampireEvoLine;
...
public class VampirePrince extends Race implements Transformation {
    ...
    private double auraMin = 3000000;
    private double auraMax = 3000000;
    private double startingMagiculeMin = 3000000;
    private double startingMagiculeMax = 3000000;
    ...
    public double getEvolutionPercentage(Player player) {
        ...
        if (storage.getSkill(Skills.CRIMSON_TYRANT.get()).isPresent()) {
            percentage += 50.0;
        } else {
            percentage += 0f;
        }
    ...
    public List<Component> getRequirementsForRendering(Player player) {
        ...
        list.add(Component.translatable("trmythos.skill.require.crimson_tyrant").withStyle(ChatFormatting.GOLD));
        return list;
    }
