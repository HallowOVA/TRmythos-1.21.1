package com.github.hallowOVA.mythos.race.HydraLine;
...
public class DarkSeaTyrantRace extends Race {
    public DarkSeaTyrantRace() {super(Difficulty.INTERMEDIATE);}
    ...
    @Override
    public double getSprintSpeed(){return 0.65;}
    ...
    public Pair<Double, Double> getBaseMagiculeRange() {
        return Pair.of(Double.valueOf(1600000.0D), Double.valueOf(1700000.0D));
    }
    ...
    public List<Race> getNextEvolutions(Player player) {
        ...
        list.add((Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.HYDRA));
        return list;
    }
    ...
    public Race getHarvestFestivalEvolution(Player player) {
        return (Race)((IForgeRegistry) TensuraRaces.RACE_REGISTRY.get()).getValue(MythosRaces.HYDRA);
    }
